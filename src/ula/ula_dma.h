...
// Set true by IRQ handler for active display lines (0-191).
// Read by Core 1 to gate contention: only contend during active display.
extern volatile bool ula_fetch_active;
